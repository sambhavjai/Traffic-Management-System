...
Outgoing_Base::Outgoing_Base(const Outgoing_Base& other) : ::omnetpp::cMessage(other)
{
    copy(other);
}
...
Outgoing_Base& Outgoing_Base::operator=(const Outgoing_Base& other)
{
...
{
    return this->green_light_time;
}

void Outgoing_Base::setGreen_light_time(int green_light_time)
{
    this->green_light_time = green_light_time;
}

int Outgoing_Base::getRed_light_time() const
{
    return this->red_light_time;
}

void Outgoing_Base::setRed_light_time(int red_light_time)
{
    this->red_light_time = red_light_time;
}

class OutgoingDescriptor : public omnetpp::cClassDescriptor
{
  private:
    mutable const char **propertynames;
  public:
    OutgoingDescriptor();
    virtual ~OutgoingDescriptor();
...
Register_ClassDescriptor(OutgoingDescriptor)

OutgoingDescriptor::OutgoingDescriptor() : omnetpp::cClassDescriptor("Outgoing", "omnetpp::cMessage")
{
    propertynames = nullptr;
}

OutgoingDescriptor::~OutgoingDescriptor()
{
    delete[] propertynames;
}

bool OutgoingDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<Outgoing_Base *>(obj)!=nullptr;
}

const char **OutgoingDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *OutgoingDescriptor::getProperty(const char *propertyname) const
{
...
const char *OutgoingDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *OutgoingDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int OutgoingDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *OutgoingDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string OutgoingDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool OutgoingDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *OutgoingDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *OutgoingDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
